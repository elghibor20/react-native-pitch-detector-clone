...
export declare enum PitchDetectorErrors {
    BASE = 0,
    LINKING_ERROR = 1,
    PERMISSIONS_ERROR = 2
}
 ...
 */
export type PitchEstimationAndroidAlgorithm = 'AMDF' | 'DYNAMIC_WAVELET' | 'FFT_PITCH' | 'FFT_YIN' | 'MPM' | 'YIN';
/**
 * Available pitch estimation algorithm for IOS.
 * @see `https://github.com/vadymmarkov/Beethoven#configuration`
 */
export type PitchEstimationIOSAlgorithm = 'BARYCENTRIC' | 'HPS' | 'JAINS' | 'MAX_VALUE' | 'QUADRACTIC' | 'QUINNS_FIRST' | 'QUINNS_SECOND' | 'YIN';
...
export interface NativeModuleImplementation extends NativeModule {
     ...
     */
    start: (config: PitchDetectorAndroidConfig | PitchDetectorIOSConfig) => Promise<void>;
    /**
