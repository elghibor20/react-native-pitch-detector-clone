...
async function request(permission, rationale) {
  ...
  return (typeof rationale === 'function' ? rationale() : showRationaleAlert(rationale)).then(shouldRequestPermission => shouldRequestPermission ? _NativePermissionsModule.default.requestPermission(permission) : _NativePermissionsModule.default.check(permission));
}
