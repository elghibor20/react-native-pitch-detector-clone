...
async function request(permission, rationale) {
  ...
  return (typeof rationale === 'function' ? rationale() : showRationaleAlert(rationale)).then(shouldRequestPermission => shouldRequestPermission ? NativeModule.requestPermission(permission) : NativeModule.check(permission));
}
